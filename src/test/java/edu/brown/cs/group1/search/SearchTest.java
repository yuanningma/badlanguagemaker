...
public class SearchTest {
  ...
  public void testConstructor() {
    ...
    List<List<String>> docs = new ArrayList<List<String>>(Arrays.asList(doc1,
        doc2));
    Search search = new Search(docs, 2);
